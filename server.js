...
// Book.find({pages:{$lt:500,$gt:200}},function(err,data){
//   if (err) {
//     console.log(err);
//   } else {
//     console.log(data);
...
// Book.find({rating:{$lt:5}}).sort('author').exec(function(err,data){
...
// Person.find({height:{$gt:180},salary:{$gt:30000}}).exec(function(err,data){
//   if(err) console.log(err);
//   console.log(data);
// });
//2. Find all the people who are tall (>180) OR rich (>30000)
// Person.find({$or:[{height:{$gt:180},salary:{$gt:30000}}]}).exec(function(err,data){
//   if(err) console.log(err);
//   console.log(data);
// });
